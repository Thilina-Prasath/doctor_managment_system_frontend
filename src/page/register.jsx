...
import { Mail, Lock, User, Eye, EyeOff, ArrowRight, Sparkles, UserPlus, Stethoscope } from 'lucide-react';
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (token) {
                ...
                // onNavigate('dashboard'); // Example for future
            } else {
                    ...
                    <div className="p-8">
                        <form onSubmit={handleSubmit} className="space-y-6">
                            ...
                            <p className="text-center text-gray-700 dark:text-gray-300 text-sm">
                                ...
                                <button type="button" onClick={() => onNavigate('register')} className="text-indigo-600 dark:text-indigo-300 hover:text-indigo-800 dark:hover:text-indigo-400 font-medium transition bg-transparent border-none cursor-pointer p-0">
                                    Sign up
                                </button>
                            </p>
                        </form>
                    ...
                    <div className="p-8">
                        <form onSubmit={handleSubmit} className="space-y-6">
                            ...
                            <p className="text-center text-gray-700 dark:text-gray-300 text-sm">
                                ...
                                <button type="button" onClick={() => onNavigate('login')} className="text-indigo-600 dark:text-indigo-300 hover:text-indigo-800 dark:hover:text-indigo-400 font-medium transition bg-transparent border-none cursor-pointer p-0">
                                    Sign in
                                </button>
                            </p>
                        </form>
